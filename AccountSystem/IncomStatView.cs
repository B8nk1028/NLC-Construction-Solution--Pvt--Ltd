...
{
    public partial class IncomStatView : Form
    {
        private MyModule Fn = new MyModule();

        public IncomStatView()
        {
            InitializeComponent();
        ...
        private static IncomStatView defaultInstance;

        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static IncomStatView Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new IncomStatView();
        ...
        private void IncomStatView_Load(object sender, EventArgs e)
        {
            ...
            this.TblAccHeadTableAdapter.Fill(this.IncomStat.TblAccHead, MyModule.CompID, Fn.FirstDayOfMonthFromDateTime(Convert.ToDateTime(sYear)), Fn.LastDayOfMonthFromDateTime(Convert.ToDateTime(eYear)));
