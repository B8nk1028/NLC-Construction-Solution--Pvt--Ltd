...
{
    public partial class rptBLSheet : Form
    {
        ...
        private static rptBLSheet defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptBLSheet Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptBLSheet();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_BalanceSheet '" + cbLocation.SelectedValue + "','" + datePicker2.Text + "'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
            ...
            {
                new ReportParameter("ReportParameter1", "As On "+datePicker2.Value.ToString("MMMM dd, yyyy"),false),
