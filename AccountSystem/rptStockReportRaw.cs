...
namespace AccountSystem
{
    public partial class rptStockReportRaw : Form
    {
        ...
        private static rptStockReportRaw defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptStockReportRaw Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptStockReportRaw();
        ...
        private void StockRptParm2_Load(object sender, EventArgs e)
        {
            ...
            cbLocation.SelectedValue = 15992;
