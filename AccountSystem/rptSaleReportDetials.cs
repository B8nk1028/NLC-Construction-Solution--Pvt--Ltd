...
namespace AccountSystem
{
    public partial class rptSaleReportDetials : Form
    {
        ...
        private static rptSaleReportDetials defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptSaleReportDetials Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptSaleReportDetials();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_SaleOrdersDetails '" + cboSalesman.SelectedValue+"','"+datePicker1.Text + "','" + datePicker2.Text+"'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "AccountSystem.rptSaleOrderDetiles.rdlc";
        ...
        private void StockRptParm2_Load(object sender, EventArgs e)
        {
            ...
            Fn.fillCombo(cboSalesman, "select * from (select '%' ids,' ALL' names union  SELECT convert(varchar,EntryAccID), EntryAccName FROM TblAccEntry WHERE (AccType IN (8,10)))tbv order by names");
