...
namespace AccountSystem
{
    public partial class rptOverdueInvoices : Form
    {
        ...
        private static rptOverdueInvoices defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptOverdueInvoices Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptOverdueInvoices();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_OverdueInvoicesRept '" + cboSalesman.SelectedValue + "','" + cbCity.SelectedValue+ "','" + regionComboBox.SelectedValue + "','" + cbLocation.SelectedValue + "'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
