...
namespace AccountSystem
{
    public partial class rptEmployeeProfitability : Form
    {
        ...
        private static rptEmployeeProfitability defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptEmployeeProfitability Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptEmployeeProfitability();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_EmployeeProfitabilityStatement '" + cboSalesman.SelectedValue + "','" + cbLocation.SelectedValue + "','"+ datePicker1.Text+ "','"+ datePicker2.Text+ "'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
            ...
            List<ReportParameter> paraList = new List<ReportParameter>
            {
                ...
                new ReportParameter("ReportParameter4", cboSalesman.Text, false),
        ...
        private void StockRptParm2_Load(object sender, EventArgs e)
        {
            ...
            Fn.fillCombo(cboSalesman, "SELECT convert(varchar,EntryAccID), EntryAccName FROM TblAccEntry WHERE (AccType = 9)");
