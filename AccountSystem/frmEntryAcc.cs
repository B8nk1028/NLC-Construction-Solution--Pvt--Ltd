...
{
    public partial class frmEntryAcc : Form
    {
        public frmEntryAcc()
        {
            InitializeComponent();
        ...
        private static frmEntryAcc defaultInstance;

        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static frmEntryAcc Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new frmEntryAcc();
