...
namespace AccountSystem
{
    public partial class rptSaleTaxReport : Form
    {
        ...
        private static rptSaleTaxReport defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptSaleTaxReport Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptSaleTaxReport();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_SaleTaxReport '" + datePicker1.Text + "','" + datePicker2.Text + "','"+cboSalesman.SelectedValue+ "'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
            DataTable dt = new DataTable();
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "AccountSystem.rptSaleTaxReport.rdlc";
