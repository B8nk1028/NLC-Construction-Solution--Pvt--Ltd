...
namespace AccountSystem
{
    public partial class rptStaffRecoverySheet : Form
    {
        ...
        private static rptStaffRecoverySheet defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptStaffRecoverySheet Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptStaffRecoverySheet();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_StaffRecoverySheet '" + cboSalesman.SelectedValue + "','" + cbLocation.SelectedValue + "','"+ datePicker1.Text+ "','"+ datePicker2.Text+ "'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
