...
{
    public partial class rptOrderStatus : Form
    {
        ...
        private static rptOrderStatus defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptOrderStatus Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptOrderStatus();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_OrderStatus '"+cbLocation.SelectedValue+"'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
