...
namespace AccountSystem
{
    public partial class rptPaymentsDtl : Form
    {
        ...
        private static rptPaymentsDtl defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptPaymentsDtl Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptPaymentsDtl();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_PaymentsDtls '" + datePicker1.Text + "','" + datePicker2.Text + "'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
