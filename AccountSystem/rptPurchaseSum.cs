...
namespace AccountSystem
{
    public partial class rptPurchaseSum : Form
    {
        ...
        private static rptPurchaseSum defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptPurchaseSum Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptPurchaseSum();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_PurchaseReport '" + datePicker1.Text + "','" + datePicker2.Text + "','"+cbLocation.SelectedValue + "','"+cboSalesman.SelectedValue+"'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
        ...
        private void btnChart_Click(object sender, EventArgs e)
        {
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "AccountSystem.rptPurchaseRegister2.rdlc";
            DataTable dt = new DataTable();
            for (int i = 0; i < DSet.Length; i++)
            {
                dt = Fn.FillDSet(SQL[i]).Tables[0];
