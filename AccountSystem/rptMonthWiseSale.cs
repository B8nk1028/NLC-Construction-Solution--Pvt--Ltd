...
namespace AccountSystem
{
    public partial class rptMonthWiseSale : Form
    {
        ...
        private static rptMonthWiseSale defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptMonthWiseSale Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptMonthWiseSale();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_monthwisesale '" + cboSalesman.SelectedValue + "','" + cbCity.SelectedValue+ "','" + regionComboBox.SelectedValue + "','" + cbLocation.SelectedValue + "','"+ datePicker1.Text+ "','"+ datePicker2.Text+ "'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
