...
namespace AccountSystem
{
    public partial class rptCashBankBalances : Form
    {
        ...
        private static rptCashBankBalances defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptCashBankBalances Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptCashBankBalances();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_CashBankBlances '" + datePicker1.Text + "','" + datePicker2.Text + "','"+cbLocation.SelectedValue + "'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
