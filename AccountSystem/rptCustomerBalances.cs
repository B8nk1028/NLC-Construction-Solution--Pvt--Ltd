...
namespace AccountSystem
{
    public partial class rptCustomerBalances : Form
    {
        ...
        private static rptCustomerBalances defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptCustomerBalances Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptCustomerBalances();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_CustomersBalances '" + datePicker1.Text + "','" + datePicker2.Text + "','"+cbLocation.SelectedValue + "','"+regionComboBox.SelectedValue+"','"+cbCity.SelectedValue+"','"+(chkPaid.Checked==true?0:-1)+"'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
