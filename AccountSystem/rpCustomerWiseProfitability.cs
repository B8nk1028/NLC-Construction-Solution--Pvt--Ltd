...
namespace AccountSystem
{
    public partial class rpCustomerWiseProfitability : Form
    {
        ...
        private static rpCustomerWiseProfitability defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rpCustomerWiseProfitability Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rpCustomerWiseProfitability();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_CustomerWiseProfit '" + cbLocation.SelectedValue + "','" + datePicker1.Text + "','" + datePicker2.Text + "','"+ cboVendor.SelectedValue+"'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
