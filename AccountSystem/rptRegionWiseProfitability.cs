...
namespace AccountSystem
{
    public partial class rptRegionWiseProfitability : Form
    {
        ...
        private static rptRegionWiseProfitability defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptRegionWiseProfitability Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptRegionWiseProfitability();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_RegionWiseProfit '" + cbLocation.SelectedValue + "','" + datePicker1.Text + "','" + datePicker2.Text + "','"+ regionComboBox.Text.Replace("ALL","%")+"','"+cbCity.SelectedValue+"'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
        ...
        private void StockRptParm2_Load(object sender, EventArgs e)
        {
            ...
            Fn.fillCombo(cbCity, "select '%','ALL' union SELECT CityNmae,CityNmae FROM tblLocations WHERE (Region LIKE '"+regionComboBox.SelectedValue+"')");
        }
    }
}