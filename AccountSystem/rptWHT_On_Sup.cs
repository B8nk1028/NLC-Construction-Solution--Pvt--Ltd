...
namespace AccountSystem
{
    public partial class rptWHT_On_Sup : Form
    {
        ...
        private static rptWHT_On_Sup defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptWHT_On_Sup Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptWHT_On_Sup();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_WHT_Supplies '" + datePicker1.Text + "','"+ datePicker2.Text + "'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
