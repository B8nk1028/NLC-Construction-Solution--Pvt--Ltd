...
namespace AccountSystem
{
    public partial class rptReceiptsReport : Form
    {
        ...
        private static rptReceiptsReport defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptReceiptsReport Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptReceiptsReport();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_ReceiptsReport '" + datePicker1.Text + "','" + datePicker2.Text + "','"+cbLocation.SelectedValue + "','"+ cVType.SelectedValue+ "'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
        ...
        private void StockRptParm2_Load(object sender, EventArgs e)
        {
            ...
            Fn.fillCombo(cVType, "select '%','ALL' union select 'BRV/','Bank Receipts' union select 'CRV/','Cash Receipts'");
