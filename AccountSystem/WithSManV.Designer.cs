namespace AccountSystem
{
    partial class WithSManV
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(WithSManV));
            this.reportViewer1 = new Microsoft.Reporting.WinForms.ReportViewer();
            this.WithSalesmanDS = new AccountSystem.WithSalesmanDS();
            this.DataTable1BindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.DataTable1TableAdapter = new AccountSystem.WithSalesmanDSTableAdapters.DataTable1TableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "AccountSystem.WithSManRpt.rdlc";
            ...
            this.DataTable1BindingSource.DataSource = this.WithSalesmanDS;
            // 
            ...
            this.Name = "WithSManV";
            this.Text = "Stock with Salesman";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.WithSManV_FormClosing);
            this.Load += new System.EventHandler(this.WithSManV_Load);
        ...
        private WithSalesmanDSTableAdapters.DataTable1TableAdapter DataTable1TableAdapter;
