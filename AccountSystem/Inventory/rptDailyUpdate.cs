...
namespace AccountSystem
{
    public partial class rptDailyUpdate : Form
    {
        ...
        private static rptDailyUpdate defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptDailyUpdate Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptDailyUpdate();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] DSet = { "DataSet1", "DataSet2", "DataSet3", "DataSet4" };
            string[] SQL = { "sp_PurchaseConsRawMat2 '" + datePicker1.Text + "','" + datePicker1.Text + "'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)", "sp_DailyProduction '" + datePicker1.Text + "','" + datePicker1.Text + "'", "sp_DailySale '" + datePicker1.Text + "'" };
