...
namespace AccountSystem
{
    public partial class rptProductCostVariation : Form
    {
        ...
        private static rptProductCostVariation defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptProductCostVariation Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptProductCostVariation();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_CostVariation '" + datePicker1.Text + "','" + datePicker2.Text + "'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
            ...
            {
                new ReportParameter("ReportParameter1", " " + datePicker1.Text+ " " +datePicker2.Text,false),
