...
namespace AccountSystem
{
    public partial class rptDailyProductReport : Form
    {
        ...
        private static rptDailyProductReport defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptDailyProductReport Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptDailyProductReport();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_DailyProductReport '" + datePicker1.Text + "','" + datePicker2.Text + "'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
