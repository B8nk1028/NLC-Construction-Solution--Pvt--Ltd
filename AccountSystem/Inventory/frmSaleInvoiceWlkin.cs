...
{
    public partial class frmSaleInvoiceWlkin : Form
    {
        private MyModule Fn = new MyModule();
        string[] cData;
        string ItemDiscount = "0", NetTotal = "0";
        public frmSaleInvoiceWlkin()
        {
            InitializeComponent();
        ...
        private static frmSaleInvoiceWlkin defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static frmSaleInvoiceWlkin Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new frmSaleInvoiceWlkin();
        ...
        private void btnsave_Click(object sender, EventArgs e)
        {
            ...
            if (grdBill.Rows.Count > 0)
            {
                ...
                string ID = Fn.GetRecords("sp_CreateSaleInvoice '" + Data2Post + "'," + cbLocation.SelectedValue + "," + btnSave.Tag+",'"+tax+"'")[0];
                btnPrint.Tag = ID;
                if (ID == "a")
                {
