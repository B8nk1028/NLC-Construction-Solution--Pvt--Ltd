...
{
    public partial class rptIncomeStatement2 : Form
    {
        ...
        private static rptIncomeStatement2 defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptIncomeStatement2 Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptIncomeStatement2();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_IncomStatment2 '" + cbLocation.SelectedValue + "','01 " + datePicker1.Text + "','" +Fn.LastDayOfMonthFromDateTime(datePicker2.Value).ToString("dd MMMM yyyy") + "'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
