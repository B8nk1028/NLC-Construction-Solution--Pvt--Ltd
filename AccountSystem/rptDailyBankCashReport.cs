...
namespace AccountSystem
{
    public partial class rptDailyBankCashReport : Form
    {
        ...
        private static rptDailyBankCashReport defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptDailyBankCashReport Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptDailyBankCashReport();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_DailyBankCash '" + datePicker1.Text + "','" + datePicker2.Text + "'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
