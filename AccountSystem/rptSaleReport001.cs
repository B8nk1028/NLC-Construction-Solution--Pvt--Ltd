...
namespace AccountSystem
{
    public partial class rptSaleReport001 : Form
    {
        ...
        private static rptSaleReport001 defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptSaleReport001 Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptSaleReport001();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] DSet = { "DataSet4", "DataSet2" };
            string[] SQL = { "sp_SalesReport2 '" + datePicker1.Text + "','" + datePicker2.Text + "','" + cboVendorCustomer.SelectedValue + "','" + cboSalesman.SelectedValue+ "'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
