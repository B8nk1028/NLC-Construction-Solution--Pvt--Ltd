...
namespace AccountSystem
{
    public partial class rptVendorBalances : Form
    {
        ...
        private static rptVendorBalances defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static rptVendorBalances Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new rptVendorBalances();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "sp_VendorsBalances '"  + datePicker1.Text + "','" + datePicker2.Text + "','"+cbLocation.SelectedValue + "'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
