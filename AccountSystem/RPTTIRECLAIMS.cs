...
namespace AccountSystem
{
    public partial class RPTTIRECLAIMS : Form
    {
        ...
        private static RPTTIRECLAIMS defaultInstance;
        /// <summary>
        /// Added by the VB.Net to C# Converter to support default instance behavour in C#
        /// </summary>
        public static RPTTIRECLAIMS Default
        {
            get
            {
                if (defaultInstance == null)
                {
                    defaultInstance = new RPTTIRECLAIMS();
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string[] SQL = { "SP_RPTTIRECLAIMS '"+datePicker1.Text+"','"+datePicker2.Text+"','" + cbLocation.SelectedValue+"'", "SELECT CompanyID, Logo FROM TblCompany WHERE (CompanyID = 1)" };
